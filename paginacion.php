...
<body>
  ...
  <!-- Código para la barra de navegación de la parte superior.  -->
	...
	<footer>
		<p class="text-center">
			Secretaria de planeación Chia<br> 
			Municipal Dirección Carrera 11 # 11 - 29 Conmutador 8844444 Chía, Cundinamarca<br>
			Horario de atención al público de 8:00 AM a 5:00 PM jornada continúa<br>
			<a href="https://twitter.com/Planeacionchia">Twitter</a> 
		</p> 
	</footer>	
	</div>
